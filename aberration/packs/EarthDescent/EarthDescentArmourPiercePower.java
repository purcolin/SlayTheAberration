...
public class EarthDescentArmourPiercePower extends AbstractPower {
    public static final String POWER_ID = AberrationMod.makeID(EarthDescentArmourPiercePower.class.getSimpleName());
    private static final Logger logger = LogManager.getLogger(EarthDescentArmourPiercePower.class.getName());
    private static final PowerStrings powerStrings;
    public static final String NAME;
    public static final String[] DESCRIPTIONS;
    private AbstractCreature source;

    public EarthDescentArmourPiercePower() {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public EarthDescentArmourPiercePower(AbstractCreature owner, AbstractCreature source) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.source = source;
