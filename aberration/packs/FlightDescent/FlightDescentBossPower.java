...
public class FlightDescentBossPower extends AbstractPower {

    public static final String POWER_ID = AberrationMod.makeID(FlightDescentBossPower.class.getSimpleName());
    private static final Logger logger = LogManager.getLogger(FlightDescentBossPower.class.getName());
    ...
    public void atStartOfTurn() {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this.owner,this.owner, new FlightDescentFlightPower(this.owner, 2)));
        logger.info("flight boss 1");
    }
