...
public class AberrationSelectScreen extends CustomScreen {

    public static final String ID = AberrationMod.makeID(AberrationSelectScreen.class.getSimpleName());
    private static final Logger logger = LogManager.getLogger(AberrationSelectScreen.class.getName());
    private static final UIStrings uiStrings;
    public static final String[] TEXT;
    public static class Enum
    {
        @SpireEnum
        public static AbstractDungeon.CurrentScreen ABERRATION_SELECT_SCREEN;
    }

    @Override
    public AbstractDungeon.CurrentScreen curScreen()
    {
        return Enum.ABERRATION_SELECT_SCREEN;
    }
